...
class Manager:
    ...
    def _process_user(self, data):
        try:
            ...
            # usuario_supervisor = self.db_connection.query_usersup(estpos, postra)
    ...
    def _generate_supervisor_email_body(self, supervisor, funcionarios):
        body = f"<strong>Olá {supervisor.title()}. Segue a lista de colaboradores que fazem aniversário este mês:<br><br></strong>"
        body += "<table border='1' cellpadding='5' cellspacing='0'>"
        body += """<tr style="background-color: #d3d3d3; color: black;"><th>Colaboradores Aniversáriantes</th><th>Data</th><th>Setor</th></tr>""" 
